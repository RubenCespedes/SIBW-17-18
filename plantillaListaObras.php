...
class Vista {
    ...
    function imprimirListaObras($ids, $paths, $titulos, $autores, $id_obras){
        include 'head.php';
        include 'header.php';
        include 'footer.php';
    ...
    function imprimirObra($id, $path, $titulo, $autor, $num){
        echo '<div class="offer-card-container">
	                    ...
	                    <div class="info-container">
	                    	 <div class="title"><a href=index.php?obra=' . $id . '>' . $titulo . ' | <span class="smaller-txt">' . $autor . '</span>
	                    	    <p>Fecha</p></a>
	                    	    <div class="enviar-mensaje"> <a href="contact.php">Editar</a></div>
	                    	 </div>
                        </div>
